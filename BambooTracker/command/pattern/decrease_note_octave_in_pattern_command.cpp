#include "decrease_note_octave_in_pattern_command.hpp"

DecreaseNoteOctaveInPatternCommand::DecreaseNoteOctaveInPatternCommand(std::weak_ptr<Module> mod,
...
void DecreaseNoteOctaveInPatternCommand::redo()
{
...
void DecreaseNoteOctaveInPatternCommand::undo()
{
	auto& sng = mod_.lock()->getSong(song_);
