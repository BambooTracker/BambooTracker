...
| *0Xxx*     | *レジスタ番地指定 バンク0 (xx: 番地 [00-B6])*                                                                             | *レジスタ番地指定 バンク0*                                                    | *レジスタ番地指定 バンク0*           |
| *0Yxx*     | *レジスタ番地指定 バンク1 (xx: 番地 [00-B6])*                                                                             | *レジスタ番地指定 バンク1*                                                    | *レジスタ番地指定 バンク1*           |
| *0Zxx*     | *レジスタ値指定 (xx: レジスタ値 [00-FF])*                                                                                 | *レジスタ値指定*                                                              | *レジスタ値指定*                     |
