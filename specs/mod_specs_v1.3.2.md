...
This version is what is revised from v1.0.1 since the tracker changes the bank loading process. All data fields are remained from [v1.3.1](./mod_specs_v1.3.1.md).
